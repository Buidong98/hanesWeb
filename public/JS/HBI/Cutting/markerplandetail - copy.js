            ...
            if (markerPlan.wh_prepare == '0' || selectedFabricRollList.length > 0) { // warehouse đã chuẩn bị phiếu - wh_prepare
                ...
                for (let i = 0; i < selectedRollList.length; i++) {
                    ...
                    html += `<tr id='tr-${ele.unipack2}'>
                                <td>
                                    <input type='checkbox' data-id='${ele.unipack2}' class='marker-select' id='cb-${ele.unipack2}' checked onchange="selectMarker()" style='transform: scale(1.5)' />
                                </td>
                                <td>${ele.unipack2}</td>
                                <td>${ele.rlocbr}</td>
                                <td>
                                    <div class="input-group eye-password">
                                        <input type="number" class="form-control" data-id='${ele.unipack2}' max="${ele.usedYard + ele.yard}" min="0" old-val="${ele.usedYard}" value="${ele.usedYard}" id="used-yard-${ele.unipack2}" onchange="yardChange()">
                                        <div class="input-group-addon">
                                            <span class="" id="inventory-yard-${ele.unipack2}">${ele.yard}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>${ele.rfinwt}</td>
                                ...
                                <td>${ele.qccomment}</td>
                                <td>
                                    <input type='text' class='form-control' data-id='${ele.unipack2}' id='note-${ele.unipack2}' value="${ele.note ? ele.note : ""}" onchange="noteChange()" />
                                </td>
                                <td>${ele.item_color}</td>
            ...
            for (let i = 0; i < itemColorRollList.length; i++) {
                ...
                if (isSelected) {
                    html += `<tr id='tr-${ele.unipack2}'>
                                ...
                                <td>
                                    <div class="input-group eye-password">
                                        <input type="number" class="form-control" data-id='${ele.unipack2}' max="${remainYard}" min="0" value="${selectedRollList[0].usedYard}" id="used-yard-${ele.unipack2}" onchange="yardChange()">
                                        <div class="input-group-addon">
                                            <span class="" id="inventory-yard-${ele.unipack2}">${remainYard}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>${ele.rfinwt}</td>
                    ...
                    if (remainYard > 0) {
                        html += `<tr id='tr-${ele.unipack2}'>
                                    <td>
                                        <input type='checkbox' data-id='${ele.unipack2}' class='marker-select' id='cb-${ele.unipack2}' onchange="selectMarker()" style='transform: scale(1.5)' />
                                    </td>
                                    <td>${ele.unipack2}</td>
                                    <td>${ele.rlocbr}</td>
                                    <td>
                                        <div class="input-group eye-password">
                                            <input type="number" class="form-control" data-id='${ele.unipack2}' max="${remainYard}" min="0" value="${remainYard}" id="used-yard-${ele.unipack2}" onchange="yardChange()" disabled>
                                            <div class="input-group-addon">
                                                <span class="" id="inventory-yard-${ele.unipack2}">${remainYard}</span>
                                            </div>
                                        </div>
                                    ...
                                    <td>${ele.qccomment}</td>
                                    <td>
                                        <input type='text' class='form-control' data-id='${ele.unipack2}' id='note-${ele.unipack2}' value="${ele.note ? ele.note : ""}" onchange="noteChange()" disabled />
                                    </td>
                                    <td>${ele.item_color}</td>
                                    <td>${ele.with_actual}</td>
                                    <td>${ele.vendor}</td>
